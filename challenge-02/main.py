...
def get_tracking_code(index,tracking_codes):
	code = tracking_codes[index]
	return code
...
def get_the_biggest(s_list):
	top_value = max(s_list)
	return top_value
...
def count_in_list(value, s_list):
	count_top_value = s_list.count(value)
	return count_top_value
